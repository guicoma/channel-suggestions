...
import { Tree, Form, Input, Select, Button, Alert, Space, Divider, Empty } from 'antd';
...
class App extends Component {
  ...
  delChannel = (treeData) => {
    ...
    switch(indexRm.length) {
      case 2:
        data.splice(indexRm[1],1)
        break;
      case 3:
        data[indexRm[1]].children.splice(indexRm[2],1)
        break;
      case 4:
        data[indexRm[1]].children[indexRm[2]].splice(indexRm[3],1)
        break;
      case 5:
        data[indexRm[1]].children[indexRm[2]].children[indexRm[3]].splice(indexRm[4],1);
        break;
      default:
      ...
      <div className="">
        <Space direction="vertical" size="large">
          ...
          {this.state.gData.length < 1 &&
              <Empty description="Añade un canal" />
          }
          <Tree
